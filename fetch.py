#!/usr/bin/env python3
"""
Recupero codici sconto eDreams da shopilo.it
Sursa: https://shopilo.it/negozi/edreams.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/edreams.it"
STORE_NAME = "eDreams"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per eDreams da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-edreams)"
    }
    try:
